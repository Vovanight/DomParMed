...
--
-- База данных: `domparmed`
--

-- --------------------------------------------------------

--
-- Структура таблицы `ga26l_action_logs`
--

CREATE TABLE `ga26l_action_logs` (
...
--
-- Структура таблицы `ga26l_action_logs_extensions`
--

CREATE TABLE `ga26l_action_logs_extensions` (
  `id` int(10) UNSIGNED NOT NULL,
  `extension` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `ga26l_action_logs_extensions`
--

INSERT INTO `ga26l_action_logs_extensions` (`id`, `extension`) VALUES
(1, 'com_banners'),
(2, 'com_cache'),
(3, 'com_categories'),
(4, 'com_config'),
...
--
-- Структура таблицы `ga26l_action_logs_users`
--

CREATE TABLE `ga26l_action_logs_users` (
...
--
-- Структура таблицы `ga26l_action_log_config`
--

CREATE TABLE `ga26l_action_log_config` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Дамп данных таблицы `ga26l_action_log_config`
--

INSERT INTO `ga26l_action_log_config` (`id`, `type_title`, `type_alias`, `id_holder`, `title_holder`, `table_name`, `text_prefix`) VALUES
...
--
-- Дамп данных таблицы `ga26l_assets`
--
...
--
-- Структура таблицы `ga26l_associations`
--

CREATE TABLE `ga26l_associations` (
...
--
-- Структура таблицы `ga26l_banners`
--

CREATE TABLE `ga26l_banners` (
  `id` int(11) NOT NULL,
...
--
-- Структура таблицы `ga26l_banner_clients`
--

CREATE TABLE `ga26l_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Структура таблицы `ga26l_banner_tracks`
--

CREATE TABLE `ga26l_banner_tracks` (
...
--
-- Структура таблицы `ga26l_categories`
--

CREATE TABLE `ga26l_categories` (
  `id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `ga26l_categories`
--

INSERT INTO `ga26l_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 630, '2020-11-03 04:41:11', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 630, '2020-11-03 04:41:11', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 630, '2020-11-03 04:41:11', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 630, '2020-11-03 04:41:11', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 630, '2020-11-03 04:41:11', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 630, '2020-11-03 04:41:11', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Структура таблицы `ga26l_contact_details`
--

CREATE TABLE `ga26l_contact_details` (
  `id` int(11) NOT NULL,
...
--
-- Структура таблицы `ga26l_content`
--

CREATE TABLE `ga26l_content` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Структура таблицы `ga26l_contentitem_tag_map`
--

CREATE TABLE `ga26l_contentitem_tag_map` (
  `type_alias` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Структура таблицы `ga26l_content_frontpage`
--

CREATE TABLE `ga26l_content_frontpage` (
...
--
-- Структура таблицы `ga26l_content_rating`
--

CREATE TABLE `ga26l_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT 0,
...
--
-- Структура таблицы `ga26l_content_types`
--

CREATE TABLE `ga26l_content_types` (
...
--
-- Дамп данных таблицы `ga26l_content_types`
--

INSERT INTO `ga26l_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Структура таблицы `ga26l_core_log_searches`
--

CREATE TABLE `ga26l_core_log_searches` (
...
--
-- Структура таблицы `ga26l_extensions`
--

CREATE TABLE `ga26l_extensions` (
...
--
-- Дамп данных таблицы `ga26l_extensions`
--
...
--
-- Структура таблицы `ga26l_fields`
--

CREATE TABLE `ga26l_fields` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `ga26l_fields_categories`
--

CREATE TABLE `ga26l_fields_categories` (
...
--
-- Структура таблицы `ga26l_fields_groups`
--

CREATE TABLE `ga26l_fields_groups` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Структура таблицы `ga26l_fields_values`
--

CREATE TABLE `ga26l_fields_values` (
...
--
-- Структура таблицы `ga26l_finder_filters`
--

CREATE TABLE `ga26l_finder_filters` (
...
--
-- Структура таблицы `ga26l_finder_links`
--

CREATE TABLE `ga26l_finder_links` (
...
--
-- Структура таблицы `ga26l_finder_links_terms0`
--

CREATE TABLE `ga26l_finder_links_terms0` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `ga26l_finder_links_terms1`
--

CREATE TABLE `ga26l_finder_links_terms1` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `ga26l_finder_links_terms2`
--

CREATE TABLE `ga26l_finder_links_terms2` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `ga26l_finder_links_terms3`
--

CREATE TABLE `ga26l_finder_links_terms3` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `ga26l_finder_links_terms4`
--

CREATE TABLE `ga26l_finder_links_terms4` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `ga26l_finder_links_terms5`
--

CREATE TABLE `ga26l_finder_links_terms5` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `ga26l_finder_links_terms6`
--

CREATE TABLE `ga26l_finder_links_terms6` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `ga26l_finder_links_terms7`
--

CREATE TABLE `ga26l_finder_links_terms7` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `ga26l_finder_links_terms8`
--

CREATE TABLE `ga26l_finder_links_terms8` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `ga26l_finder_links_terms9`
--

CREATE TABLE `ga26l_finder_links_terms9` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `ga26l_finder_links_termsa`
--

CREATE TABLE `ga26l_finder_links_termsa` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `ga26l_finder_links_termsb`
--

CREATE TABLE `ga26l_finder_links_termsb` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `ga26l_finder_links_termsc`
--

CREATE TABLE `ga26l_finder_links_termsc` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `ga26l_finder_links_termsd`
--

CREATE TABLE `ga26l_finder_links_termsd` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `ga26l_finder_links_termse`
--

CREATE TABLE `ga26l_finder_links_termse` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `ga26l_finder_links_termsf`
--

CREATE TABLE `ga26l_finder_links_termsf` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `ga26l_finder_taxonomy`
--

CREATE TABLE `ga26l_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `title` varchar(255) NOT NULL,
...
--
-- Дамп данных таблицы `ga26l_finder_taxonomy`
--
...
--
-- Структура таблицы `ga26l_finder_taxonomy_map`
--

CREATE TABLE `ga26l_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `ga26l_finder_terms`
--

CREATE TABLE `ga26l_finder_terms` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `ga26l_finder_terms_common`
--

CREATE TABLE `ga26l_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Дамп данных таблицы `ga26l_finder_terms_common`
--

INSERT INTO `ga26l_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Структура таблицы `ga26l_finder_tokens`
--

CREATE TABLE `ga26l_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) UNSIGNED NOT NULL DEFAULT 0,
  `phrase` tinyint(1) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Структура таблицы `ga26l_finder_tokens_aggregate`
--

CREATE TABLE `ga26l_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `ga26l_finder_types`
--

CREATE TABLE `ga26l_finder_types` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `ga26l_languages`
--

CREATE TABLE `ga26l_languages` (
...
--
-- Дамп данных таблицы `ga26l_languages`
--
...
--
-- Структура таблицы `ga26l_menu`
--

CREATE TABLE `ga26l_menu` (
  `id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `ga26l_menu`
--
...
--
-- Структура таблицы `ga26l_menu_types`
--

CREATE TABLE `ga26l_menu_types` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Дамп данных таблицы `ga26l_menu_types`
--

INSERT INTO `ga26l_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `ga26l_messages`
--

CREATE TABLE `ga26l_messages` (
...
--
-- Структура таблицы `ga26l_messages_cfg`
--

CREATE TABLE `ga26l_messages_cfg` (
...
--
-- Структура таблицы `ga26l_modules`
--

CREATE TABLE `ga26l_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
...
--
-- Дамп данных таблицы `ga26l_modules`
--
...
--
-- Структура таблицы `ga26l_modules_menu`
--

CREATE TABLE `ga26l_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT 0,
  `menuid` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `ga26l_modules_menu`
--

INSERT INTO `ga26l_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Структура таблицы `ga26l_newsfeeds`
--

CREATE TABLE `ga26l_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT 0,
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `ga26l_overrider`
--

CREATE TABLE `ga26l_overrider` (
...
--
-- Структура таблицы `ga26l_postinstall_messages`
--

CREATE TABLE `ga26l_postinstall_messages` (
...
--
-- Дамп данных таблицы `ga26l_postinstall_messages`
--

INSERT INTO `ga26l_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Структура таблицы `ga26l_privacy_consents`
--

CREATE TABLE `ga26l_privacy_consents` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Структура таблицы `ga26l_privacy_requests`
--

CREATE TABLE `ga26l_privacy_requests` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `ga26l_redirect_links`
--

CREATE TABLE `ga26l_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `ga26l_schemas`
--

CREATE TABLE `ga26l_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `ga26l_schemas`
--

INSERT INTO `ga26l_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.9.22-2020-09-16');

-- --------------------------------------------------------

--
-- Структура таблицы `ga26l_session`
--

CREATE TABLE `ga26l_session` (
...
--
-- Структура таблицы `ga26l_tags`
--

CREATE TABLE `ga26l_tags` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `lft` int(11) NOT NULL DEFAULT 0,
  `rgt` int(11) NOT NULL DEFAULT 0,
...
--
-- Дамп данных таблицы `ga26l_tags`
--

INSERT INTO `ga26l_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 630, '2020-11-03 04:41:11', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Структура таблицы `ga26l_template_styles`
--

CREATE TABLE `ga26l_template_styles` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Дамп данных таблицы `ga26l_template_styles`
--

INSERT INTO `ga26l_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Структура таблицы `ga26l_ucm_base`
--

CREATE TABLE `ga26l_ucm_base` (
...
--
-- Структура таблицы `ga26l_ucm_content`
--

CREATE TABLE `ga26l_ucm_content` (
...
--
-- Структура таблицы `ga26l_ucm_history`
--

CREATE TABLE `ga26l_ucm_history` (
...
--
-- Структура таблицы `ga26l_updates`
--

CREATE TABLE `ga26l_updates` (
...
--
-- Структура таблицы `ga26l_update_sites`
--

CREATE TABLE `ga26l_update_sites` (
...
--
-- Дамп данных таблицы `ga26l_update_sites`
--
...
--
-- Структура таблицы `ga26l_update_sites_extensions`
--

CREATE TABLE `ga26l_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT 0,
  `extension_id` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Дамп данных таблицы `ga26l_update_sites_extensions`
--
...
--
-- Структура таблицы `ga26l_usergroups`
--

CREATE TABLE `ga26l_usergroups` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
...
--
-- Дамп данных таблицы `ga26l_usergroups`
--

INSERT INTO `ga26l_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Структура таблицы `ga26l_users`
--

CREATE TABLE `ga26l_users` (
  `id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `ga26l_users`
--
...
--
-- Структура таблицы `ga26l_user_keys`
--

CREATE TABLE `ga26l_user_keys` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `ga26l_user_notes`
--

CREATE TABLE `ga26l_user_notes` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `catid` int(10) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Структура таблицы `ga26l_user_profiles`
--

CREATE TABLE `ga26l_user_profiles` (
...
--
-- Структура таблицы `ga26l_user_usergroup_map`
--

CREATE TABLE `ga26l_user_usergroup_map` (
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `ga26l_user_usergroup_map`
--

INSERT INTO `ga26l_user_usergroup_map` (`user_id`, `group_id`) VALUES
(630, 8);

-- --------------------------------------------------------

--
-- Структура таблицы `ga26l_utf8_conversion`
--

CREATE TABLE `ga26l_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `ga26l_utf8_conversion`
--

INSERT INTO `ga26l_utf8_conversion` (`converted`) VALUES
(5);

-- --------------------------------------------------------

--
-- Структура таблицы `ga26l_viewlevels`
--

CREATE TABLE `ga26l_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT 0,
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Дамп данных таблицы `ga26l_viewlevels`
--

INSERT INTO `ga26l_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Индексы таблицы `ga26l_action_logs`
--
...
--
-- Индексы таблицы `ga26l_action_logs_extensions`
--
ALTER TABLE `ga26l_action_logs_extensions`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `ga26l_action_logs_users`
--
ALTER TABLE `ga26l_action_logs_users`
  ADD PRIMARY KEY (`user_id`),
  ADD KEY `idx_notify` (`notify`);

--
-- Индексы таблицы `ga26l_action_log_config`
--
...
--
-- Индексы таблицы `ga26l_associations`
--
ALTER TABLE `ga26l_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Индексы таблицы `ga26l_banners`
--
ALTER TABLE `ga26l_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `ga26l_banner_clients`
--
ALTER TABLE `ga26l_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Индексы таблицы `ga26l_banner_tracks`
--
ALTER TABLE `ga26l_banner_tracks`
...
--
-- Индексы таблицы `ga26l_categories`
--
ALTER TABLE `ga26l_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `ga26l_contact_details`
--
ALTER TABLE `ga26l_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Индексы таблицы `ga26l_contentitem_tag_map`
--
ALTER TABLE `ga26l_contentitem_tag_map`
...
--
-- Индексы таблицы `ga26l_content_frontpage`
--
ALTER TABLE `ga26l_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Индексы таблицы `ga26l_content_rating`
--
ALTER TABLE `ga26l_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Индексы таблицы `ga26l_content_types`
--
ALTER TABLE `ga26l_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`(100));

--
-- Индексы таблицы `ga26l_extensions`
--
...
--
-- Индексы таблицы `ga26l_fields`
--
ALTER TABLE `ga26l_fields`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Индексы таблицы `ga26l_fields_categories`
--
ALTER TABLE `ga26l_fields_categories`
  ADD PRIMARY KEY (`field_id`,`category_id`);

--
-- Индексы таблицы `ga26l_fields_groups`
--
ALTER TABLE `ga26l_fields_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Индексы таблицы `ga26l_fields_values`
--
ALTER TABLE `ga26l_fields_values`
  ADD KEY `idx_field_id` (`field_id`),
  ADD KEY `idx_item_id` (`item_id`(191));

--
-- Индексы таблицы `ga26l_finder_filters`
--
ALTER TABLE `ga26l_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Индексы таблицы `ga26l_finder_links`
--
...
--
-- Индексы таблицы `ga26l_finder_links_terms0`
--
ALTER TABLE `ga26l_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `ga26l_finder_links_terms1`
--
ALTER TABLE `ga26l_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `ga26l_finder_links_terms2`
--
ALTER TABLE `ga26l_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `ga26l_finder_links_terms3`
--
ALTER TABLE `ga26l_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `ga26l_finder_links_terms4`
--
ALTER TABLE `ga26l_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `ga26l_finder_links_terms5`
--
ALTER TABLE `ga26l_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `ga26l_finder_links_terms6`
--
ALTER TABLE `ga26l_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `ga26l_finder_links_terms7`
--
ALTER TABLE `ga26l_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `ga26l_finder_links_terms8`
--
ALTER TABLE `ga26l_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `ga26l_finder_links_terms9`
--
ALTER TABLE `ga26l_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `ga26l_finder_links_termsa`
--
ALTER TABLE `ga26l_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `ga26l_finder_links_termsb`
--
ALTER TABLE `ga26l_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `ga26l_finder_links_termsc`
--
ALTER TABLE `ga26l_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `ga26l_finder_links_termsd`
--
ALTER TABLE `ga26l_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `ga26l_finder_links_termse`
--
ALTER TABLE `ga26l_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `ga26l_finder_links_termsf`
--
ALTER TABLE `ga26l_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `ga26l_finder_taxonomy`
--
...
--
-- Индексы таблицы `ga26l_finder_taxonomy_map`
--
ALTER TABLE `ga26l_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Индексы таблицы `ga26l_finder_terms`
--
...
--
-- Индексы таблицы `ga26l_finder_terms_common`
--
ALTER TABLE `ga26l_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Индексы таблицы `ga26l_finder_tokens`
--
ALTER TABLE `ga26l_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Индексы таблицы `ga26l_finder_tokens_aggregate`
--
ALTER TABLE `ga26l_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Индексы таблицы `ga26l_finder_types`
--
...
--
-- Индексы таблицы `ga26l_languages`
--
...
--
-- Индексы таблицы `ga26l_menu_types`
--
ALTER TABLE `ga26l_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Индексы таблицы `ga26l_messages`
--
ALTER TABLE `ga26l_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Индексы таблицы `ga26l_messages_cfg`
--
ALTER TABLE `ga26l_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Индексы таблицы `ga26l_modules`
--
...
--
-- Индексы таблицы `ga26l_modules_menu`
--
ALTER TABLE `ga26l_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Индексы таблицы `ga26l_newsfeeds`
--
ALTER TABLE `ga26l_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Индексы таблицы `ga26l_overrider`
--
ALTER TABLE `ga26l_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `ga26l_postinstall_messages`
--
ALTER TABLE `ga26l_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Индексы таблицы `ga26l_privacy_consents`
--
ALTER TABLE `ga26l_privacy_consents`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`);

--
-- Индексы таблицы `ga26l_privacy_requests`
--
ALTER TABLE `ga26l_privacy_requests`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `ga26l_redirect_links`
--
ALTER TABLE `ga26l_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Индексы таблицы `ga26l_schemas`
--
ALTER TABLE `ga26l_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Индексы таблицы `ga26l_session`
--
ALTER TABLE `ga26l_session`
...
--
-- Индексы таблицы `ga26l_tags`
--
ALTER TABLE `ga26l_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `ga26l_template_styles`
--
ALTER TABLE `ga26l_template_styles`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `ga26l_ucm_base`
--
ALTER TABLE `ga26l_ucm_base`
...
--
-- Индексы таблицы `ga26l_ucm_content`
--
ALTER TABLE `ga26l_ucm_content`
...
--
-- Индексы таблицы `ga26l_ucm_history`
--
...
--
-- Индексы таблицы `ga26l_updates`
--
ALTER TABLE `ga26l_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Индексы таблицы `ga26l_update_sites`
--
ALTER TABLE `ga26l_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Индексы таблицы `ga26l_update_sites_extensions`
--
ALTER TABLE `ga26l_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Индексы таблицы `ga26l_usergroups`
--
ALTER TABLE `ga26l_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `ga26l_users`
--
ALTER TABLE `ga26l_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `ga26l_user_keys`
--
ALTER TABLE `ga26l_user_keys`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `series` (`series`),
  ADD KEY `user_id` (`user_id`);

--
-- Индексы таблицы `ga26l_user_notes`
--
ALTER TABLE `ga26l_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Индексы таблицы `ga26l_user_profiles`
--
ALTER TABLE `ga26l_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Индексы таблицы `ga26l_user_usergroup_map`
--
ALTER TABLE `ga26l_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Индексы таблицы `ga26l_viewlevels`
--
...
--
-- AUTO_INCREMENT для таблицы `ga26l_action_log_config`
--
ALTER TABLE `ga26l_action_log_config`
...
--
-- AUTO_INCREMENT для таблицы `ga26l_banner_clients`
--
ALTER TABLE `ga26l_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ga26l_categories`
--
ALTER TABLE `ga26l_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT для таблицы `ga26l_contact_details`
--
ALTER TABLE `ga26l_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT для таблицы `ga26l_fields_groups`
--
ALTER TABLE `ga26l_fields_groups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ga26l_finder_filters`
--
ALTER TABLE `ga26l_finder_filters`
...
--
-- AUTO_INCREMENT для таблицы `ga26l_messages`
--
ALTER TABLE `ga26l_messages`
...
--
-- AUTO_INCREMENT для таблицы `ga26l_overrider`
--
ALTER TABLE `ga26l_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';

--
-- AUTO_INCREMENT для таблицы `ga26l_postinstall_messages`
--
ALTER TABLE `ga26l_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT для таблицы `ga26l_privacy_consents`
--
ALTER TABLE `ga26l_privacy_consents`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ga26l_privacy_requests`
--
ALTER TABLE `ga26l_privacy_requests`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ga26l_redirect_links`
--
ALTER TABLE `ga26l_redirect_links`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ga26l_tags`
--
ALTER TABLE `ga26l_tags`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `ga26l_template_styles`
--
ALTER TABLE `ga26l_template_styles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT для таблицы `ga26l_ucm_content`
--
ALTER TABLE `ga26l_ucm_content`
...
--
-- AUTO_INCREMENT для таблицы `ga26l_users`
--
ALTER TABLE `ga26l_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=631;

--
-- AUTO_INCREMENT для таблицы `ga26l_user_keys`
--
ALTER TABLE `ga26l_user_keys`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ga26l_user_notes`
--
ALTER TABLE `ga26l_user_notes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ga26l_viewlevels`
--
ALTER TABLE `ga26l_viewlevels`
