...
class JBLayoutHelper extends AppHelper
{
     ...
     * @return null|string
     */
    public function renderItemFront(Item $item, $defaultLayout = 'teaser_magazin', ItemRenderer $renderer = null)
    {
        $this->app->jbdebug->mark('teaser_magazin::renderItemFront (' . $item->id . ')::start');
        ...
        $this->app->jbdebug->mark('teaser_magazin::itemRender (' . $item->id . ')::finish');
