<?php /* D:\OSPanel\domains\DomParMed\administrator\components\com_akeeba\ViewTemplates\Backup\default.blade.php */ ?>
<?php
/**
		...
		<div id="errorframe">
			...
			<div class="akeeba-block--info" id="error-panel-troubleshooting">
				<p>
					...
					<?php echo \Joomla\CMS\Language\Text::sprintf('COM_AKEEBA_BACKUP_TEXT_RTFMTOSOLVE', 'https://www.akeeba.com/documentation/akeeba-backup-documentation/troubleshoot-backup.html?utm_source=akeeba_backup&utm_campaign=backuperrorlink'); ?>
				</p>
				<p>
					<?php if(AKEEBA_PRO): ?>
